...
export(String, "Ribbon", "Closing Ribbon", "Spark", "Spark Closest", "", "Direction Point") var Type = "Ribbon"
var types :Array = ["Ribbon", "Closing Ribbon", "Spark", "Spark Closest", "Wave"]
export(String, "None", "Width Bounce", "Rainbow", "Fading", "Wave") var Effect = "None"
...
export(float, 0.001, 999.0) var effect_speed :float = 1.0
#Managed
